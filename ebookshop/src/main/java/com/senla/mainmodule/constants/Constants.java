...
public class Constants {
    ...
    public static final String PATH_BOOK_DATA_TEST = "ebookshop/src/book.dat";
    public static final String PATH_ORDER_DATA_TEST = "ebookshop/src/order.dat";
    public static final String PATH_REQUEST_DATA_TEST = "ebookshop/src/request.dat";
